           ...
           <div className="relative animate-slide-up">
              <div className="border-l-4 border-red-600 bg-black/80 backdrop-blur-md p-8 shadow-[0_0_50px_rgba(220,38,38,0.2)]">
                ...
                <div className="flex flex-wrap gap-4">
                  <a href="/projects" className="flex items-center gap-2 bg-red-600 hover:bg-red-700 text-black px-6 py-3 font-bold uppercase tracking-widest transition-all shadow-[0_0_20px_rgba(220,38,38,0.4)]">
                    <Terminal size={18} /> View Operations
                  </a>
                  
                  {/* Public folder reference starts with / */}
                  <a href="/resume.pdf" download="Tushar_Saini_Resume.pdf" className="flex items-center gap-2 border border-red-600 text-red-500 hover:bg-red-600 hover:text-black px-6 py-3 font-bold uppercase tracking-widest transition-all cursor-pointer z-50">
